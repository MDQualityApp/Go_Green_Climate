...
import collection from '../../assets/removebg-preview-1-Apn.png'
...
import flag7 from '../../assets/icon-flag-9an.png'
import Header from '../Header/Header';

const DesktopComponent3 = () => {
    return (
        <Box className="desktop-3-jKU">
         <Header />
            ...
            <Box className="auto-group-vue1-SsQ">
                ...
                <img className="icon-flag-vxv" src={flag7} alt="icon7" />
            </Box>
        </Box>
    );
};
